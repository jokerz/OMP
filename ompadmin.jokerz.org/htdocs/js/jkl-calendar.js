...
JKL.Calendar.prototype.write = function () {
    ...
    src1 += '<td id="__'+this.eid+'_btn_prev" title="前の月へ">≪</td>';
    src1 += '<td>'+(year)+'</span>年 '+(mon+1)+'</span>月</td>';
    src1 += '<td id="__'+this.eid+'_btn_close" title="閉じる">×</td>';
    src1 += '<td id="__'+this.eid+'_btn_next" title="次の月へ">≫</td>';
    src1 += "</tr></table>\n";
