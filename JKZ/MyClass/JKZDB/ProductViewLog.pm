...
# @desc		
#			
# @package	JKZ::JKZDB::ProductViewLog
# @access	public
...
# @version	1.20
#******************************************************
package MyClass::JKZDB::ProductViewLog;
...
$self->{columnslist}->{product_id}->[$i] = $aryref->[$i]->[3];
$self->{columnslist}->{product_name}->[$i] = $aryref->[$i]->[3];
...
$sqlMoji .= " ,product_id" if  $param->{product_id} != "";
$sqlMoji .= " ,product_name" if  $param->{product_name} ne "";
$sqlMoji .= " ,pvcount";
$sqlMoji .= ") VALUES (";
#************************ AUTO  GENERATED  END ************************
#************************ AUTO GENERATED BEGIN ************************
...
if ($param->{product_id} != "") { push @placeholder,$param->{product_id}; $sqlMoji .= ", ?"; }
if ($param->{product_name} ne "") { push @placeholder,$param->{product_name}; $sqlMoji .= ", ?"; }
$sqlMoji .= ", 1";
#************************ AUTO  GENERATED  END ************************
$sqlMoji .= ")";
