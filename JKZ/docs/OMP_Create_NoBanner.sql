DROP TABLE IF EXISTS `dOMP`.`base_ad`;
CREATE TABLE  `dOMP`.`base_ad` (
...
DROP TABLE IF EXISTS `dOMP`.`base_admailmanage`;
CREATE TABLE  `dOMP`.`base_admailmanage` (
  `admailno` int(10) unsigned NOT NULL default '0' COMMENT 'メール回数',
...
DROP TABLE IF EXISTS `dOMP`.`base_adpointmanage`;
CREATE TABLE  `dOMP`.`base_adpointmanage` (
  `admailno` int(10) unsigned NOT NULL default '0' COMMENT 'メール回数',
  `adid` int(10) unsigned NOT NULL default '0' COMMENT '広告ID',
...
DROP TABLE IF EXISTS `dOMP`.`error_mail`;
CREATE TABLE  `dOMP`.`error_mail` (
...
DROP TABLE IF EXISTS `dOMP`.`sessions`;
CREATE TABLE  `dOMP`.`sessions` (
  `id` char(32) NOT NULL,
  `a_session` text,
...
DROP TABLE IF EXISTS `dOMP`.`tAccessLogF`;
CREATE TABLE  `dOMP`.`tAccessLogF` (
...
DROP TABLE IF EXISTS `dOMP`.`tAdcontents`;
CREATE TABLE  `dOMP`.`tAdcontents` (
  `admailno` int(10) unsigned NOT NULL default '0' COMMENT 'メール回数',
  `carrier` tinyint(3) unsigned NOT NULL default '0' COMMENT 'キャリア種別',
...
DROP TABLE IF EXISTS `dOMP`.`tAdinfo`;
CREATE TABLE  `dOMP`.`tAdinfo` (
...
DROP TABLE IF EXISTS `dOMP`.`tAdmail`;
CREATE TABLE  `dOMP`.`tAdmail` (
...
DROP TABLE IF EXISTS `dOMP`.`tAdmailsetting`;
CREATE TABLE  `dOMP`.`tAdmailsetting` (
  `admailno` int(10) unsigned NOT NULL default '0' COMMENT 'メール回数',
...
DROP TABLE IF EXISTS `dOMP`.`tAdminPointConfM`;
CREATE TABLE  `dOMP`.`tAdminPointConfM` (
...
DROP TABLE IF EXISTS `dOMP`.`tAdsetmail`;
CREATE TABLE  `dOMP`.`tAdsetmail` (
  `admailno` int(10) unsigned NOT NULL default '0' COMMENT 'メール回数',
  `carrier` tinyint(3) unsigned NOT NULL default '0' COMMENT 'キャリア種別',
  `adid` int(10) unsigned NOT NULL default '0' COMMENT '広告ID',
...
DROP TABLE IF EXISTS `dOMP`.`tAdvAccessLogF`;
CREATE TABLE  `dOMP`.`tAdvAccessLogF` (
...
DROP TABLE IF EXISTS `dOMP`.`tAdvM`;
CREATE TABLE  `dOMP`.`tAdvM` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
DROP TABLE IF EXISTS `dOMP`.`tAffiliateAccessLogF`;
CREATE TABLE  `dOMP`.`tAffiliateAccessLogF` (
...
DROP TABLE IF EXISTS `dOMP`.`tAffiliateM`;
CREATE TABLE  `dOMP`.`tAffiliateM` (
  `acd` char(10) NOT NULL,
  `status_flag` tinyint(3) unsigned NOT NULL default '1',
  `valid_date` date NOT NULL,
  `expire_date` date NOT NULL,
...
DROP TABLE IF EXISTS `dOMP`.`tBannerDataF`;
CREATE TABLE  `dOMP`.`tBannerDataF` (
  `id` int(11) unsigned NOT NULL auto_increment,
...
DROP TABLE IF EXISTS `dOMP`.`tBannerDataM`;
CREATE TABLE  `dOMP`.`tBannerDataM` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `bannerm_id` int(10) unsigned NOT NULL COMMENT 'tBannerMのid 複合のキーになる',
  `status_flag` tinyint(1) unsigned NOT NULL default '0',
...
DROP TABLE IF EXISTS `dOMP`.`tBannerImageF`;
CREATE TABLE  `dOMP`.`tBannerImageF` (
...
DROP TABLE IF EXISTS `dOMP`.`tBannerM`;
CREATE TABLE  `dOMP`.`tBannerM` (
...
DROP TABLE IF EXISTS `dOMP`.`tCategoryM`;
CREATE TABLE  `dOMP`.`tCategoryM` (
...
DROP TABLE IF EXISTS `dOMP`.`tCmsMemberM`;
CREATE TABLE  `dOMP`.`tCmsMemberM` (
...
DROP TABLE IF EXISTS `dOMP`.`tCommunityAdmissionF`;
CREATE TABLE  `dOMP`.`tCommunityAdmissionF` (
...
DROP TABLE IF EXISTS `dOMP`.`tCommunityCategoryM`;
CREATE TABLE  `dOMP`.`tCommunityCategoryM` (
...
DROP TABLE IF EXISTS `dOMP`.`tCommunityM`;
CREATE TABLE  `dOMP`.`tCommunityM` (
...
DROP TABLE IF EXISTS `dOMP`.`tCommunityMemberM`;
CREATE TABLE  `dOMP`.`tCommunityMemberM` (
...
DROP TABLE IF EXISTS `dOMP`.`tCommunityTopicCommentF`;
CREATE TABLE  `dOMP`.`tCommunityTopicCommentF` (
...
DROP TABLE IF EXISTS `dOMP`.`tCommunityTopicF`;
CREATE TABLE  `dOMP`.`tCommunityTopicF` (
...
DROP TABLE IF EXISTS `dOMP`.`tFriendIntroAccessLogF`;
CREATE TABLE  `dOMP`.`tFriendIntroAccessLogF` (
  `in_date` char(6) NOT NULL COMMENT '%y%m%d',
  `guid` char(30) NOT NULL,
...
DROP TABLE IF EXISTS `dOMP`.`tIchiLogF`;
CREATE TABLE  `dOMP`.`tIchiLogF` (
...
DROP TABLE IF EXISTS `dOMP`.`tJKZSessionF`;
CREATE TABLE  `dOMP`.`tJKZSessionF` (
...
DROP TABLE IF EXISTS `dOMP`.`tMailAddressLogF`;
CREATE TABLE  `dOMP`.`tMailAddressLogF` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `guid` char(30) NOT NULL,
...
DROP TABLE IF EXISTS `dOMP`.`tMailSettingM`;
CREATE TABLE  `dOMP`.`tMailSettingM` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
DROP TABLE IF EXISTS `dOMP`.`tMediaAccessLogF`;
CREATE TABLE  `dOMP`.`tMediaAccessLogF` (
...
DROP TABLE IF EXISTS `dOMP`.`tMediaAgentM`;
CREATE TABLE  `dOMP`.`tMediaAgentM` (
...
DROP TABLE IF EXISTS `dOMP`.`tMediaCategoryM`;
CREATE TABLE  `dOMP`.`tMediaCategoryM` (
...
DROP TABLE IF EXISTS `dOMP`.`tMediaM`;
CREATE TABLE  `dOMP`.`tMediaM` (
...
DROP TABLE IF EXISTS `dOMP`.`tMemberM`;
CREATE TABLE  `dOMP`.`tMemberM` (
...
DROP TABLE IF EXISTS `dOMP`.`tMessageInBoxF`;
CREATE TABLE  `dOMP`.`tMessageInBoxF` (
...
DROP TABLE IF EXISTS `dOMP`.`tMessageOutBoxF`;
CREATE TABLE  `dOMP`.`tMessageOutBoxF` (
...
DROP TABLE IF EXISTS `dOMP`.`tMonthM`;
CREATE TABLE  `dOMP`.`tMonthM` (
  `DMON` tinyint(2) unsigned zerofill NOT NULL,
  PRIMARY KEY  (`DMON`)
) ENGINE=MyISAM DEFAULT CHARSET=sjis;

DROP TABLE IF EXISTS `dOMP`.`tMyIchi`;
CREATE TABLE  `dOMP`.`tMyIchi` (
  `owid` int(10) unsigned NOT NULL,
...
DROP TABLE IF EXISTS `dOMP`.`tMyImageF`;
CREATE TABLE  `dOMP`.`tMyImageF` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
DROP TABLE IF EXISTS `dOMP`.`tMyLinkListF`;
CREATE TABLE  `dOMP`.`tMyLinkListF` (
  `owid` int(10) unsigned NOT NULL,
...
DROP TABLE IF EXISTS `dOMP`.`tMyMessageBoardF`;
CREATE TABLE  `dOMP`.`tMyMessageBoardF` (
...
DROP TABLE IF EXISTS `dOMP`.`tMyPageMediaF`;
CREATE TABLE  `dOMP`.`tMyPageMediaF` (
...
DROP TABLE IF EXISTS `dOMP`.`tOrderDataF`;
CREATE TABLE  `dOMP`.`tOrderDataF` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
DROP TABLE IF EXISTS `dOMP`.`tOrderDetailF`;
CREATE TABLE  `dOMP`.`tOrderDetailF` (
...
DROP TABLE IF EXISTS `dOMP`.`tPageViewLogF`;
CREATE TABLE  `dOMP`.`tPageViewLogF` (
...
DROP TABLE IF EXISTS `dOMP`.`tPointLogF`;
CREATE TABLE  `dOMP`.`tPointLogF` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `owid` int(10) unsigned NOT NULL,
  `guid` char(30) NOT NULL,
...
DROP TABLE IF EXISTS `dOMP`.`tProductDecoTmplt`;
CREATE TABLE  `dOMP`.`tProductDecoTmplt` (
...
DROP TABLE IF EXISTS `dOMP`.`tProductImageM`;
CREATE TABLE  `dOMP`.`tProductImageM` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
DROP TABLE IF EXISTS `dOMP`.`tProductM`;
CREATE TABLE  `dOMP`.`tProductM` (
...
DROP TABLE IF EXISTS `dOMP`.`tProductSwf`;
CREATE TABLE  `dOMP`.`tProductSwf` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `productm_id` int(10) unsigned NOT NULL,
...
DROP TABLE IF EXISTS `dOMP`.`tProductViewLogF`;
CREATE TABLE  `dOMP`.`tProductViewLogF` (
  `in_date` date NOT NULL COMMENT 'DATE yyyy-mm',
  `carrier` tinyint(1) unsigned NOT NULL,
...
DROP TABLE IF EXISTS `dOMP`.`tProfilePageSettingM`;
CREATE TABLE  `dOMP`.`tProfilePageSettingM` (
...
DROP TABLE IF EXISTS `dOMP`.`tSiteImageM`;
CREATE TABLE  `dOMP`.`tSiteImageM` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `image` mediumblob,
...
DROP TABLE IF EXISTS `dOMP`.`tSubCategoryM`;
CREATE TABLE  `dOMP`.`tSubCategoryM` (
...
DROP TABLE IF EXISTS `dOMP`.`tSmallCategoryM`;
CREATE TABLE  `dOMP`.`tSmallCategoryM` (
...
DROP TABLE IF EXISTS `dOMP`.`tTmpltFileF`;
CREATE TABLE  `dOMP`.`tTmpltFileF` (
...
DROP TABLE IF EXISTS `dOMP`.`tTmpltM`;
CREATE TABLE  `dOMP`.`tTmpltM` (
...
DROP TABLE IF EXISTS `dOMP`.`tUserRegistLogF`;
CREATE TABLE  `dOMP`.`tUserRegistLogF` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `owid` int(10) unsigned NOT NULL,
  `guid` char(30) NOT NULL COMMENT 'DCMGUID',
...
DROP TABLE IF EXISTS `dOMP`.`tBannerClickF`;
CREATE TABLE  `dOMP`.`tBannerClickF` (
  `owid` int(10) unsigned NOT NULL default '0',
...
DROP TABLE IF EXISTS `dOMP`.`tBannerCountF`;
CREATE TABLE  `dOMP`.`tBannerCountF` (
  `bannerm_id` int(10) unsigned NOT NULL COMMENT 'tBannerM.id',
  `bannerdatam_id` int(10) unsigned NOT NULL COMMENT 'tBannerDataM.id',
